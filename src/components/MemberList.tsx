    ...
    <div className="bg-card-bg rounded-2xl border border-card-border p-6 shadow-sm flex flex-col gap-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-foreground">함께 읽는 이들의 여정</h3>
        </div>
        <span className="text-xs text-foreground/50 font-medium">참여자 {memberProgresses.length}명</span>
      </div>
